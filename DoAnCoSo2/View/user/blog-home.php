...
$articles = $article->loadAllArticleByPage($page);
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-3">
                    <div class="input-group">
                        <form action="" method="get">
                            <input class="form-control p-3" type="text" name="article"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-5">
                            <div class="card h-100 shadow border-0">
                                <img class="card-img" src="<?php echo $row['img'] ?>" alt="...">
                                <div class="card-body p-4">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-2">News</div>
                                    <a class="text-decoration-none link-dark stretched-link"
                                        href="./article-view.php?id=<?php echo $row['articleId'] ?>">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="small">
                                                <div class="fw-bold">
                                                    <?php 
                                                if (isset($articles)){
                                                    if($userInfo->checkUserInfo($row['userId'])) {
                                                        $userInfo->loadUserInfo($row['userId']);
                                                    }
                    ...
                    <nav aria-label="Pagination">
                        ...
                        <ul class="pagination justify-content-center my-4">
                            ...
                            <li class="page-item"><a class="page-link"
                                    href="./blog-home.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                            </li>
                            <?php endif; ?>
                            <?php endfor ?>
                        </ul>
