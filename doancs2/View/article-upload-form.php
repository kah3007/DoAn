<?php
    ...
    if (isset($_GET['id'])) {
        ...
        if(!empty($arData)){
            $imageUrl = isset($arData[0]['img']) ? $arData[0]['img'] : '';
...
<body>
    <div role="main" class="form-all">
        ...
        <form id="article-submit" action="../View/article-upload-form.php" method="post" class="was-validated" data-image-url="<?php echo $imageUrl; ?>">
            <div class="mb-6">
                <label class="form-label">Submit as :
                    <?php echo isset($arData) ? $arData[0]['userId'] : $_SESSION['username']?></label>
            </div>
            <div class="mb-3">
                <label for="inputTitle" class="form-label">Title</label>
                <input type="text" class="form-control" id="inputTitle" name="inputTitle"
                    value="<?php echo isset($arData) ? $arData[0]['title'] : ''; ?>" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control " id="inputContent" name="inputContent" placeholder="Required content"
                    required><?php echo isset($arData) ? $arData[0]['content'] : ''; ?></textarea>
                <div class="invalid-feedback">
