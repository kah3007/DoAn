                            ...
                            <?php foreach ($allArticle as $article): ?>
                                <tr>
                                    ...
                                    <?php if ($article['approved'] === 2): ?>
                                        <td><a id="showArc" type="button" class="btn btn-outline-success  "  onclick="toggleApproval(<?php echo $article['articleId']?>, 1)">Show</a></td>
                                    <?php else:?>
                                        <td><a id="hideArc"  type="button" class="btn btn-outline-secondary" onclick="toggleApproval(<?php echo $article['articleId']?>, 2)">Hide</td>
                                    <?php endif;?>
